...
uint8_t current_beat_frame = 0;

static void render_ryly_love_animation(void) {
    static const char PROGMEM heart_fill_frames[8][ANIM_SIZE] = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
    ...
    static const char PROGMEM final_animation[2][ANIM_SIZE] = {
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x60, 0x30, 0x18, 0x08, 0x08, 0x08, 0x08,
0x08, 0x08, 0x08, 0x38, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
,
...
0x40, 0x20, 0x10, 0x1e, 0x37, 0x22, 0x21, 0x30, 0x10, 0xc8, 0xbc, 0x87, 0x41, 0x60, 0x20, 0x10,
0x18, 0x0c, 0x04, 0xff, 0x01, 0x00, 0x00, 0x00, 0x80, 0xff, 0x61, 0x3f, 0x20, 0x20, 0xf8, 0x1c,
0x0f, 0x87, 0x81, 0x80, 0xc0, 0x40, 0x70, 0x18, 0x00, 0x01, 0x03, 0x07, 0x0f, 0x0f, 0x07, 0x03,
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
    ...
    if (is_idling) {
        current_tap_frame = (current_tap_frame + 1) % 7;
    }

    if (get_current_wpm() < IDLE_SPEED) {
        if (current_tap_frame > 0 && !is_idling) {
    ...
    if (get_current_wpm() >= IDLE_SPEED) {
        ...
        if (current_tap_frame < 7) {
            ++current_tap_frame;
        }

        if (current_tap_frame >= 7) {
            current_beat_frame += 1;

            oled_write_raw_P(final_animation[current_beat_frame % 2], sizeof(heart_fill_frames[0]));
            return;
        }
